        ...
        <div className="wp-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {page.images.map((image) => (
              <div
                key={image.id}
                className="wp-card wp-card-interactive overflow-hidden group border-2 border-transparent hover:border-brand-primary"
              >
                ...
                <div className="p-4">
                  <h3 className="font-heading text-xl font-semibold text-brand-text  mb-1">
                    {image.title}
                  </h3>
                  <p className="text-brand-text/75  text-sm flex items-center gap-1">
          ...
          <div className="text-center mt-12">
            <p className="text-brand-text/75  mb-4">{page.ctaText}</p>
            <a
